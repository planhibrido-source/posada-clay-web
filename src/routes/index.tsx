...
import heroImage from "../assets/hero-posada.jpg.asset.json";
    ...
    <main id="inicio" className="site-shell">
      ...
      <section className="hero" aria-labelledby="hero-title">
        <img
          ...
          src={heroImage.url}
          alt="Fachada artesanal en arcilla de la Posada Luz Caraballo en Mérida"
          width={768}
          height={1024}
        />
        ...
        <div className="hero-copy">
          ...
          <h1 id="hero-title">Posada en Mérida<br />Hospedaje Merideño 👨‍👩‍👧‍👦🚍</h1>
